...
author:
  - name: Author # Jürgen Schneider 
    url: website # https://uni-tuebingen.de/de/28915
    affiliation: affiliation # Universität Tübingen
    email: email # juergen.schneider@uni-tuebingen.de
date: "`r Sys.Date()`"
output: 
  html_document:
    toc: true
...
```
Can't share data on github, but you can get the __open data__ via the repository [Link to data repository shared after blind peer-review]  
